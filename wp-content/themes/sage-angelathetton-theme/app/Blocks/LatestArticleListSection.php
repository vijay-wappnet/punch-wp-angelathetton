...
class LatestArticleListSection
{
    ...
    public static function render($block, $content = '', $is_preview = false, $post_id = 0)
    {
        ...
        $see_all_articles_button = get_field('see_all_articles_button') ?: [];
        ...
        echo view('blocks.latest-article-list-section', [
            ...
            'see_all_articles_button' => $see_all_articles_button,
    ...
    /**
     * Get post publish date in "F j, Y" format
     *
     * @param int $post_id The post ID
     * @return string The formatted publish date
     */
    public static function getPostPublishDate($post_id)
    {
