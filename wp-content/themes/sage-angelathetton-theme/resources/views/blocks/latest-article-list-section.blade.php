...
@endif
<section id="{{ $blockId }}" class="latest-article-list-section" @if(!empty($backgroundStyle))
        ...
        @if($title)
            <div class="lals__header">
                ...
                @if(!empty($see_all_articles_button['button_link']['url']) && !empty($see_all_articles_button['button_text']))
                    <a href="{{ esc_url($see_all_articles_button['button_link']['url']) }}"
                        ...
                        @if(!empty($see_all_articles_button['aria_label']))
                        aria-label="{{ esc_attr($see_all_articles_button['aria_label']) }}" @endif
                        @if(!empty($see_all_articles_button['button_google_event_label']))
                        data-google-event-label="{{ esc_attr($see_all_articles_button['button_google_event_label']) }}" @endif>
